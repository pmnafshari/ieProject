                                ...
                                <div class="card col-12">
                                    <div class="card-body d-flex flex-column py-5">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="keywordTextarea" rows="3" name="keyword"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="descriptionTextarea">description</label>
                                            <textarea class="form-control" id="descriptionTextarea" rows="3" name="description"></textarea>
                                        </div>
