            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">ویرایش  خدمت {{ $service->title }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body ">
                          ...
                          <form action="{{route('service.update',$service)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group  col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="IDOnvaneKhedmat"  value="{{$service->title}}" name="title" aria-describedby="nameHelp" placeholder="نام خود را وارد کنید">
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <select class=" select2 " name="branch_id" id="khadamatSelect " >
                                        ...
                                        @foreach($branches as $branch)
                                            <option
                                                @if($branch->id == $service->branch_id)
                                                selected
                                                @endif
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <select class=" select2 " name="servicetime" id="IDZamanHodoodiSelect" data-number-target="fa" >
                                        <option  @if($service->servicetime == 30)
                                                 selected
                                                 @endif value="30">30</option>
                                        <option @if($service->servicetime == 60)
                                                selected
                                                @endif value="60">60</option>
                                        <option  @if($service->servicetime == 90)
                                                 selected
                                                 @endif value="90">90</option>
                                        <option  @if($service->servicetime == 120)
                                                 selected
                                                 @endif value="120">120</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"  value="{{$service->price}}" name="price" id="IDHazine">
...
{{--                                        @foreach(\App\Models\admin\Provider::all() as $provider)--}}
...
{{--                                        @endforeach--}}
                                        @foreach(\App\Models\Provider::all() as $provider)
                                            <option
                                                ...
                                                @if($service->hasProviders($provider) )
                                                    selected
                                                @endif
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" value="{{$service->prepayment}}" name="prepayment"  id="IDdarsadPishpardakht" min="0" max="100">
                                        <div class="input-group-append">
                                            <div class="input-group-text" id="btnGroupAddon2">
                                                درصد
                                            </div>
                                ...
                                <div class="form-group mb-3 col-md-6 ">
                                    <label for="inputGroupFile">آپلود تصاویر اصلی جدید </label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="inputGroupFile02" name="file" multiple>
                                        <label class="custom-file-label " for="inputGroupFile">آپلود تصویر اصلی جدید</label>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"  value="{{$service->period}}" name="period" id="IDModatTamdid" aria-describedby="tamdidHelp" >
                                        <div class="input-group-append">
                                            <div class="input-group-text" id="btnGroupAddon2">
                                                روز
                                            </div>
                                ...
                                <div class="col-md-12 col-lg-3 p-1 my-2">
                                    <div class="card w-200 h-200 rounded px-2 py-2 ">

                                        <img class="card-img-top img-responsive rounded" src="{{$service->file}}" alt="Card image cap">
                                        <!-- /.card-body -->
                                        <div class="card-footer bg-transparent mt-auto">

                                            <input type="text" class="btn btn-block btn-info " value="تصویر اصلی خدمت">
                            ...
                            <div class="d-flex justify-content-center mt-5 mb-2 text-center">
                                <input type="submit" class="btn btn-success text-center " value="ثبت خدمت ">
                            </div>
