                        ...
                        <form action="{{route('account.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group  col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" aria-describedby="nameHelp"  required placeholder="نام مجموعه را وارد کنید">
                            ...
                            <div class=" mb-3 col-md-6 ">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="logo" required name="logo"/>
