            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">ویرایش شاخه‌ی خدمت {{$branch->title}}</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body ">
                        ...
                        <form action="{{route('branch.update', $branch)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group  col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"  value="{{$branch->title}}" aria-describedby="nameHelp" placeholder="عنوان شاخه خدمت را وارد کنید">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <span class="input-group-text">
                                      <i class="fa fa-calendar"></i>
                                        ...
                                        <input class="normal-example form-control example1" name="create_date" id="IDTarikhTavallod" value="{{$branch->create_date}}" >
                                    </div>
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <div class="col-md-12 col-lg-3 p-1 my-2">
                                            <div class="card w-200 h-200 rounded px-2 py-2 ">
                                                ...
                                                <img class="card-img-top img-responsive rounded" src="{{$branch->icon}}" alt="Card image cap">
                                                <!-- /.card-body -->
                            ...
                            <div class="text-center mt-5 mb-2">
                                <input type="submit" class="btn btn-success mx-auto mt-5 d-block" value="ثبت تغییرات ">
                            </div>
