                        ...
                        <form action="{{route('role.store')}}" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group  col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="IDOnvanInput" name="title" aria-describedby="onvanHelp" placeholder=" عنوان  را وارد کنید">
                                    <small id="onvanHelp" class="form-text text-muted">عنوان نقش</small>
                                </div>


                                <div class="form-group col-12 ">
                                    <label for="IDDastresiHa" class="  px-2 pt-0 font-weight-bold row">
                                ...
                                <div class="text-center mt-5 mb-2">
                                    <input type="submit" class="btn btn-success text-center " value="ایجاد نقش جدید">
                                </div>
