                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <span class="input-group-text">
                                      <i class="fa fa-calendar"></i>
                                        ...
                                        <input class="normal-example form-control example1" value="{{$user->date_of_birth}}"  name="date_of_birth" id="IDTarikhTavallod"  >
                                    </div>
                                </div>
                                            ...
                                            @foreach($user->children as $child)
                                                ...
                                                <div class="row" id="row-${key}">
                                                    ...
                                                    <div class="col-10">
                                                        <div class="form-group">
                                                            <label>تاریخ تولد</label>
                                                            <input class="form-control example1" id="${key}" value="{{jdate($child->date)->format('%d / %m / %Y')}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
                                                        <label >اقدامات</label>
