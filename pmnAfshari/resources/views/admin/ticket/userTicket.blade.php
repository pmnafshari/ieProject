            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        ...
                        <form action="{{route('storeUserTicket')}}" method="post" enctype="multipart/form-data" >
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 ">
                                    <label for="khadamatSelect">کاربر مورد نظر</label>
                                    <select class=" select2 " name="user_id" id="khadamatSelect " >
