                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="row border rounded p-3 my-1" method="post" action="{{route('workTime.store')}}" >
                                    @csrf
                                    <div class=" form-group col-6" id="startTimeContainer">
                                        ...
                                        <select  class="time select2 custom-select border-0 p-0 m-0 bg-transparent "  name="start" id="IDStartTime"
                                            ...
                                            <option value="" disabled selected >ساعت شروع</option>
                                    ...
                                    <div class=" form-group col-6 ">
                                        ...
                                        <select  class="time select2 custom-select border-0 p-0 m-0 bg-transparent "  name="end" id="IDEndTime"
                                                 data-animate="fade" data-filter-placeholder="از اینجا جستجو کنید" data-filter="true" >
                                            <option value="" disabled selected>ساعت پایان</option>

                                        </select>
                                    </div>
                                    <div class="text-right my-3 mb-2">
                                        <input type="submit" class="btn btn-success text-center mb-2" value="ثبت ساعت کاری" aria-describedby="workingTimeSubmitHelp">
